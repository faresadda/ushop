...
export default function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      var res;
      if (isEditMode) {
        res = await updateProduct(id, formData, calculateDiscount);
      } else {
        res = await addProduct(formData, calculateDiscount);
      }
  ...
  return (
    <div className="min-h-[80vh] bg-white p-2 sm:p-6 rounded-xl">
